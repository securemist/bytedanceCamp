...
func (c *commentClient) CommentAction(ctx context.Context, in *CommentActionRequest, opts ...grpc.CallOption) (*CommentActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/douyin.extra.first.Comment/CommentAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentClient) CommentList(ctx context.Context, in *CommentListRequest, opts ...grpc.CallOption) (*CommentListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/douyin.extra.first.Comment/CommentList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Comment_CommentAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/douyin.extra.first.Comment/CommentAction",
	}
...
func _Comment_CommentList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/douyin.extra.first.Comment/CommentList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Comment_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "douyin.extra.first.Comment",
